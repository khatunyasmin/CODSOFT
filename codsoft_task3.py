...
root.configure(bg='#c0e57c')  # Set background color lightgreen
...
style.configure('TButton', font=('Helvetica', 14), foreground='red', background='#4CAF50') # green
style.map('TButton', foreground=[('active', 'blue'), ('pressed', 'green')], background=[('active', 'purple'), ('pressed', 'crimson')])  # Darker Green on Click
